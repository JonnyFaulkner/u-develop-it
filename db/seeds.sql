...
VALUES
    ('James', 'Fraser', 'js@goldenbough.edu'),
    ...
    ('Antionette', 'Capet', 'acapet@dontloseyourhead.com'),
    ('Samuel', 'Delany', 'sdelany@halgren.com'),
    ('Tony', 'Duvert', 'sdelany@dhalgren.com'),
